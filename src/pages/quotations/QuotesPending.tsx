...
export default function QuotesPending() {
  ...
  const buildInquiryEmail = (q: Quotation, r: PendingRow, id: string): InboxEmail => {
    ...
    return {
      ...
      thread: [],
      attachments: [{ id: `att-req-${q.id}`, name: 'Requirement-Sheet.pdf', size: '92 KB', type: 'PDF' }],
